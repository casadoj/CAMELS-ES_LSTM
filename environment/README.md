El archivo `environment.yml` en la carpeta `Pretratamiento` contiene las librerías necesarias para el tratamiento de datos previo a la creación del conjunto de datos CAMELS-ESP.
